...
public class MoveSystem : JobComponentSystem
{
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        var jobHandle = Entities
               .WithNativeDisableParallelForRestriction(waypointPositions)
               .WithName("MoveSystem")
               .ForEach((ref Translation position, ref TankData tankData, ref Rotation rotation) =>
               {
               ...
               .WithDisposeOnCompletion(waypointPositions)
               .Schedule(inputDeps);
